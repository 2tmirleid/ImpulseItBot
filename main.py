...
from routers import start_router, project_router, bug_router, create_bug_router, edit_bug_router, delete_bug_router, \
    excel_router
...
dp.include_routers(delete_bug_router.router)
dp.include_routers(excel_router.router)
